...
export default function TekneDetayPage() {
  ...
  if (yukleniyor) {
    return (
      <div style={{ minHeight: '100vh', background: '#050e1d', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Georgia,serif' }}>
  ...
  const glow = tekne.glow ?? `${tekne.renk}80`
    ...
    <div style={{ minHeight: '100vh', background: '#050e1d', fontFamily: "'Georgia', serif", color: 'white' }}>
      ...
      <div style={{ maxWidth: '640px', margin: '0 auto', padding: '0 20px 60px' }}>
        ...
        <div className="detail-card" style={{ textAlign: 'center', marginBottom: '24px' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: '14px', margin: '0 0 12px' }}>{tekne.model}{tekne.yil ? ` · ${tekne.yil}` : ''}</p>
